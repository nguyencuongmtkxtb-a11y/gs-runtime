/**
 * Scaffold templates — markdown/config content generated during `gs init`.
 * Separated from scaffold.ts to keep logic and content concerns distinct.
 */
...
export function readme(projectName: string): string {
  return `# ${projectName}
...
export function projectOverview(projectName: string): string {
...
export function codeStandards(projectName: string): string {
...
export function systemArchitecture(projectName: string): string {
...
export function projectRoadmap(projectName: string): string {
...
export function deploymentGuide(projectName: string): string {
...
export function featurePlanTemplate(): string {
...
export function refactorTemplate(): string {
...
export function orchestrationProtocol(): string {
